...
require('lazy').setup({
  ...
  require 'cocoed.plugins.lsp_formatter',
  require 'cocoed.plugins.colorscheme',
  require 'cocoed.plugins.mini_ecosystem',
  require 'cocoed.plugins.treesitter',
  require 'cocoed.plugins.general_workflow',
  ...
  -- require 'cocoed.plugins.lint',
  require 'cocoed.plugins.git_setup', -- adds gitsigns recommended keymaps
